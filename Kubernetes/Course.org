...
- [[#container-orchestration][Container Orchestration]]
  ...
  - [[#building-container-images-1][Building Container Images]]
  - [[#security][Security]]
...
Theyre called containers as a metaphor aiming at shipping docker, and additional features like running containers without root. Plus Pods.
*** Demo: Running Containers
1. Install docker or podman
2. Setup an ngnix container
3. Start, list and stop the container
